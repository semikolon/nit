...
**Cross-references**: `~/dotfiles/docs/2026-04-29-audit-master.md` (cross-project synthesis); `~/Projects/nit/docs/MIGRATION_CHECKLIST.md` (operational); `~/dotfiles/.claude/specs/nit/{requirements,design,tasks}.md` (canonical spec).
